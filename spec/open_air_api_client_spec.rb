...
describe Sinclair::OpenAirApiClient do
  subject  { Sinclair::OpenAirApiClient.new(username: 'Username', password: 'Password', company: 'Pivotal', client: 'Client', key: 'APIKEY', limit: '5') }
  ...
  describe '#send_request' do
    it 'makes multiple OpenAir requests when the number of responses is greater than the limit' do
      ...
      expect(names).to match_array(['Big Company', 'Blah Client', 'Capital One, National Association', 'Classified Ventures, L.L.C.', 'Fancy Client', 'Humana', 'Pivotal Internal'])
    end
